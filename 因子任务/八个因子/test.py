...
import CashEquivalentPS,ARTRate,OperatingProfitToTOR,CashConversionCycle,DAVOL5,alpha167,SBM,ChaikinOscillator


for f in [ 'CashEquivalentPS','ARTRate' ,'OperatingProfitToTOR' ,'CashConversionCycle', 'DAVOL5', 'alpha167' ,'SBM' ,'ChaikinOscillator']:
